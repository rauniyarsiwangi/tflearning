...
module "lcipddmredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddmredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.7"
  os_disk_name          = "lcipddmredisdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipddmredisdb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipddmredisdb01"
