...
module "lcipddmmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddmmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.6"
  os_disk_name          = "lcipddmmariadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddmmariadb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddmmariadb01"
