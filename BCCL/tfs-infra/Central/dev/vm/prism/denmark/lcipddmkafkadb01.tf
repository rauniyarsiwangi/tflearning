...
module "lcipddmkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddmkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.8"
  os_disk_name          = "lcipddmkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddmkafkadb01"
      size           = "Standard_D2as_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddmkafkadb01"
