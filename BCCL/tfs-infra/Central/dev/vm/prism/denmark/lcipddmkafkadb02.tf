...
module "lcipddmkafkadb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddmkafkadb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.9"
  os_disk_name          = "lcipddmkafkadb02"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddmkafkadb02"
      size           = "Standard_D2as_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddmkafkadb02"
