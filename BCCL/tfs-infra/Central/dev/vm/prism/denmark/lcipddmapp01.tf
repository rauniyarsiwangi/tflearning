...
module "lcipddmapp01" {
  ...
  os_type = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-dm-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipddmapp01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.0.69"
  os_disk_name          = "lcipddmapp01"
