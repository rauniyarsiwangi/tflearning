...
module "lcipdssomongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdssomongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.16"
  os_disk_name          = "lcipdssomongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdssomongodb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdssomongodb01"
