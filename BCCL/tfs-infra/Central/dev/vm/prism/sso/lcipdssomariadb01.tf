...
module "lcipdssomariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdssomariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.19"
  os_disk_name          = "lcipdssomariadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdssomariadb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdssomariadb01"
