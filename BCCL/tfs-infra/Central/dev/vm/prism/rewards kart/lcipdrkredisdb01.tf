...
module "lcipdrkredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdrkredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.66"
  os_disk_name          = "lcipdrkredisdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdrkredisdb01"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdrkredisdb01"
