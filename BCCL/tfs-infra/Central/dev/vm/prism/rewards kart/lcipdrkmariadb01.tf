...
module "lcipdrkmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdrkmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.40"
  os_disk_name          = "lcipdrkmariadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdrkmariadb01"
      size           = "Standard_D2ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdrkmariadb01"
