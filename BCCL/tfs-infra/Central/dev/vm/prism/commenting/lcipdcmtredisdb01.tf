...
module "lcipdcmtredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdcmtredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.43"
  os_disk_name          = "lcipdcmtredisdb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdcmtredisdb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdcmtredisdb01"
