...
module "lcipdcmtkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdcmtkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.44"
  os_disk_name          = "lcipdcmtkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdcmtkafkadb01"
      size           = "Standard_D8s_v3"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdcmtkafkadb01"
