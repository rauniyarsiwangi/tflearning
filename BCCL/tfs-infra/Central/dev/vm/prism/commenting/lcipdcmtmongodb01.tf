...
module "lcipdcmtmongodb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-cmt-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdcmtmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.42"
  os_disk_name          = "lcipdcmtmongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdcmtmongodb01"
      size                            = "Standard_D8s_v3"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdcmtmongodb01"
