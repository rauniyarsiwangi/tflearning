...
module "lcipdchrmongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdchrmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.47"
  os_disk_name          = "lcipdchrmongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdchrmongodb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdchrmongodb01"
