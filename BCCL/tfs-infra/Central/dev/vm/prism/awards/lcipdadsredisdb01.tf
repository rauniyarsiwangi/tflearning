...
module "lcipdadsredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdadsredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.31"
  os_disk_name          = "lcipdadsredisdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdadsredisdb01"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdadsredisdb01"
