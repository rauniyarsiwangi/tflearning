...
module "lcipdcmgkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdcmgkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.29"
  os_disk_name          = "lcipdcmgkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdcmgkafkadb01"
      size           = "Standard_D8s_v3"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdcmgkafkadb01"
