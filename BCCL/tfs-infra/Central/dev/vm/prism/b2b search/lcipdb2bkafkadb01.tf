...
module "lcipdb2bkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdb2bkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.24"
  os_disk_name          = "lcipdb2bkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdb2bkafkadb01"
      size           = "Standard_D2ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdb2bkafkadb01"
