...
module "lcipdb2bmongodb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-b2b-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdb2bmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.26"
  os_disk_name          = "lcipdb2bmongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdb2bmongodb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdb2bmongodb01"
