...
module "lcipdb2bsolrdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdb2bsolrdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.25"
  os_disk_name          = "lcipdb2bsolrdb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdb2bsolrdb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdb2bsolrdb01"
