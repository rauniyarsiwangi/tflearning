...
module "lcipdmdgnginxdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdmdgnginxdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.15"
  os_disk_name          = "lcipdmdgnginxdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdmdgnginxdb01"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdmdgnginxdb01"
