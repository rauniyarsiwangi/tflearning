...
module "lcipdibclickdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdibclickdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.52"
  os_disk_name          = "lcipdibclickdb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdibclickdb01"
      size           = "Standard_D16as_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdibclickdb01"
