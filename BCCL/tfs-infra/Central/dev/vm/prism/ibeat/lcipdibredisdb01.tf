...
module "lcipdibredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdibredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.50"
  os_disk_name          = "lcipdibredisdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdibredisdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdibredisdb01"
