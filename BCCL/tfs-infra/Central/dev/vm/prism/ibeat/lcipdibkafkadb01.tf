...
module "lcipdibkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdibkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.54"
  os_disk_name          = "lcipdibkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdibkafkadb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdibkafkadb01"
