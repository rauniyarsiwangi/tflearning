...
module "lcipdcmsmongodb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-cms-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdcmsmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.34"
  os_disk_name          = "lcipdcmsmongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdcmsmongodb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdcmsmongodb01"
