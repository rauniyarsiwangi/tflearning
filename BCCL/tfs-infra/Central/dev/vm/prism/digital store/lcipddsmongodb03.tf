...
module "lcipddsmongodb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddsmongodb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.38"
  os_disk_name          = "lcipddsmongodb03"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddsmongodb03"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddsmongodb03"
