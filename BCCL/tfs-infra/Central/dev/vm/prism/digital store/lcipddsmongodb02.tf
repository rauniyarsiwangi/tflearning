...
module "lcipddsmongodb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddsmongodb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.37"
  os_disk_name          = "lcipddsmongodb02"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddsmongodb02"
      size           = "Standard_D2s_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddsmongodb02"
