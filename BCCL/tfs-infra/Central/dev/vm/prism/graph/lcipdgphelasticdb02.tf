...
module "lcipdgphelasticdb02" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-gph-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgphelasticdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.12"
  os_disk_name          = "lcipdgphelasticdb02"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdgphelasticdb02"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdgphelasticdb02"
