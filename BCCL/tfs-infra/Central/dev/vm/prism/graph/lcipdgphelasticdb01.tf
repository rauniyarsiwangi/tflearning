...
module "lcipdgphelasticdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgphelasticdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.11"
  os_disk_name          = "lcipdgphelasticdb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdgphelasticdb01"
      size           = "Standard_D4ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdgphelasticdb01"
