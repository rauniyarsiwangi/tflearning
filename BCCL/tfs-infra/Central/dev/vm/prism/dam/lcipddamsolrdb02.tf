...
module "lcipddamsolrdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddamsolrdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.65"
  os_disk_name          = "lcipddamsolrdb02"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipddamsolrdb02"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipddamsolrdb02"
