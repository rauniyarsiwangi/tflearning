...
module "lcipddammariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddammariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.22"
  os_disk_name          = "lcipddammariadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipddammariadb01"
      size           = "Standard_D2ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipddammariadb01"
