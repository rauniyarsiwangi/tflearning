...
module "lcipddamsolrdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipddamsolrdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.64"
  os_disk_name          = "lcipddamsolrdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipddamsolrdb01"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipddamsolrdb01"
