...
module "lcipdmramongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdmramongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.67"
  os_disk_name          = "lcipdmramongodb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdmramongodb01"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdmramongodb01"
