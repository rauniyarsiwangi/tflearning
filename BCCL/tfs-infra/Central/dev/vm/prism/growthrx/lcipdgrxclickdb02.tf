...
module "lcipdgrxclickdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgrxclickdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.58"
  os_disk_name          = "lcipdgrxclickdb02"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdgrxclickdb02"
      size                            = "Standard_E16ads_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdgrxclickdb02"
