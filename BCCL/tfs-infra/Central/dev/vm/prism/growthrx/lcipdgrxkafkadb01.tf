...
module "lcipdgrxkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgrxkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.59"
  os_disk_name          = "lcipdgrxkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdgrxkafkadb01"
      size           = "Standard_D8s_v3"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdgrxkafkadb01"
