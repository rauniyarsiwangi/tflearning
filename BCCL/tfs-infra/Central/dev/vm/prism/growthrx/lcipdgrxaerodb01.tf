...
module "lcipdgrxaerodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgrxaerodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.60"
  os_disk_name          = "lcipdgrxaerodb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdgrxaerodb01"
      size           = "Standard_E16ads_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdgrxaerodb01"
