...
module "lcipdgrxbatchdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgrxbatchdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.55"
  os_disk_name          = "lcipdgrxbatchdb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdgrxbatchdb01"
      size           = "Standard_D16ls_v5"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdgrxbatchdb01"
