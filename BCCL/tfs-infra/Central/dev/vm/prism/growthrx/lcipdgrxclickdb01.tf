...
module "lcipdgrxclickdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdgrxclickdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.57"
  os_disk_name          = "lcipdgrxclickdb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdgrxclickdb01"
      size                            = "Standard_D16as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdgrxclickdb01"
