...
module "lcipdchnkafkadb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-chn-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdchnkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.46"
  os_disk_name          = "lcipdchnkafkadb01"
  ...
  vm_config = {
    "vm1" = {
      name           = "lcipdchnkafkadb01"
      size           = "Standard_DS4_v2"
      admin_username = "azureadmin"
      admin_password = null
      computer_name = "lcipdchnkafkadb01"
