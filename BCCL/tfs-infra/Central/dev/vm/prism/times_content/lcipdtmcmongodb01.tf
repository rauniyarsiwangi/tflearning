...
module "lcipdtmcmongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipdtmcmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.72"
  os_disk_name          = "lcipdtmcmongodb01"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcipdtmcmongodb01-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipdtmcmongodb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipdtmcmongodb01"
