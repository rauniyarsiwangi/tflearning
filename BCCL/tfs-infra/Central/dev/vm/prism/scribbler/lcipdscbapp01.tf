...
module "lcipdscbapp01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-dev-prism-scb-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipdscbapp01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.0.203"
  os_disk_name          = "lcipdscbapp01"
