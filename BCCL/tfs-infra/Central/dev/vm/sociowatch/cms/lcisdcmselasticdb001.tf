...
module "lcisdcmselasticdb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcisdcmselasticdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.63"
  os_disk_name          = "lcisdcmselasticdb001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcisdcmselasticdb001"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcisdcmselasticdb001"
