...
module "lcisdgoldenimageapp001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcisdgoldenimageapp001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.0.193"
  os_disk_name          = "lcisdgoldenimageapp001"
  caching_type          = "ReadWrite"
  disk_type             = "StandardSSD_LRS"
  os_disk_size_gb       = "128"
  os_publisher          = "solvedevops1643693563360"
  os_offer              = "fedora-linux-38"
  os_sku                = "plan001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcisdgoldenimageapp001"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcisdgoldenimageapp001"
