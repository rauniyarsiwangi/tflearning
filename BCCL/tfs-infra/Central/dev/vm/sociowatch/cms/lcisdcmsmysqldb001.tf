...
module "lcisdcmsmysqldb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcisdcmsmysqldb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.61"
  os_disk_name          = "lcisdcmsmysqldb001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcisdcmsmysqldb001"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcisdcmsmysqldb001"
