...
module "lcisdcmskafkadb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcisdcmskafkadb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.12.8.62"
  os_disk_name          = "lcisdcmskafkadb001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcisdcmskafkadb001"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcisdcmskafkadb001"
