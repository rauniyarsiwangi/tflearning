...
module "lcippgphelasticdb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippgphelasticdb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.65"
  os_disk_name          = "lcippgphelasticdb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippgphelasticdb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippgphelasticdb03"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippgphelasticdb03"
