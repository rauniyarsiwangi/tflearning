...
module "lcipppgphcassandradb05" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipppgphcassandradb05"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.51"
  os_disk_name          = "lcipppgphcassandradb05"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcipppgphcassandradb05_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipppgphcassandradb05"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipppgphcassandradb05"
