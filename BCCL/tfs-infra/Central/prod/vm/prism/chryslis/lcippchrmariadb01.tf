...
module "lcippchrmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippchrmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.230"
  os_disk_name          = "lcippchrmariadb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippchrmariadb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippchrmariadb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippchrmariadb01"
