...
module "lcippchrmongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippchrmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.226"
  os_disk_name          = "lcippchrmongodb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippchrmongodb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippchrmongodb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippchrmongodb01"
