...
module "lcippssokafkadb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssokafkadb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.101"
  os_disk_name          = "lcippssokafkadb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssokafkadb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssokafkadb02"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssokafkadb02"
