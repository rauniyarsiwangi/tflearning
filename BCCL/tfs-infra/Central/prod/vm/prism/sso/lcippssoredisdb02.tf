...
module "lcippssoredisdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssoredisdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.94"
  os_disk_name          = "lcippssoredisdb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssoredisdb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssoredisdb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssoredisdb02"
