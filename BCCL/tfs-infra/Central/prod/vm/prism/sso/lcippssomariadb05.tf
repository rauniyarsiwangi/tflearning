...
module "lcippssomariadb05" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssomariadb05"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.109"
  os_disk_name          = "lcippssomariadb05"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssomariadb05_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssomariadb05"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssomariadb05"
