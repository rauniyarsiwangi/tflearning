...
module "lcippssoredisdb04" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssoredisdb04"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.96"
  os_disk_name          = "lcippssoredisdb04"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssoredisdb04_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssoredisdb04"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssoredisdb04"
