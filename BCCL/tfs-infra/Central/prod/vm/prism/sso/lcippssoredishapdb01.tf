...
module "lcippssoredishapdb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-sso-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcippssoredishapdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.28"
  os_disk_name          = "lcippssoredishapdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssoredishapdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssoredishapdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssoredishapdb01"
