...
module "lcippssomariadb04" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssomariadb04"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.108"
  os_disk_name          = "lcippssomariadb04"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssomariadb04_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssomariadb04"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssomariadb04"
