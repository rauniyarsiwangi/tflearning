...
module "lcippssomongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssomongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.87"
  os_disk_name          = "lcippssomongodb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssomongodb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssomongodb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssomongodb01"
