...
module "lcippssomongodb04" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssomongodb04"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.90"
  os_disk_name          = "lcippssomongodb04"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssomongodb04_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssomongodb04"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssomongodb04"
