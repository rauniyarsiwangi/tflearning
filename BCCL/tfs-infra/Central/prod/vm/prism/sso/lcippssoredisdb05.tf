...
module "lcippssoredisdb05" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssoredisdb05"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.97"
  os_disk_name          = "lcippssoredisdb05"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssoredisdb05_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssoredisdb05"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssoredisdb05"
