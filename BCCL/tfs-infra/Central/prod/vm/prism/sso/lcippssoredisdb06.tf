...
module "lcippssoredisdb06" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippssoredisdb06"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.98"
  os_disk_name          = "lcippssoredisdb06"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippssoredisdb06_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippssoredisdb06"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippssoredisdb06"
