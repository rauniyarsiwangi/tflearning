...
module "lcippmdgmongodb004" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmdgmongodb004"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.43"
  os_disk_name          = "lcippmdgmongodb004"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippmdgmongodb004_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmdgmongodb004"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmdgmongodb004"
