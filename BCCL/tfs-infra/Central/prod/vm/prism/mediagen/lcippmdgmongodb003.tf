...
module "lcippmdgmongodb003" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmdgmongodb003"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.42"
  os_disk_name          = "lcippmdgmongodb003"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippmdgmongodb003_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmdgmongodb003"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmdgmongodb003"
