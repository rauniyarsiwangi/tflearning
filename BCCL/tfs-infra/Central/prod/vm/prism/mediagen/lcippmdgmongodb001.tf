...
module "lcippmdgmongodb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmdgmongodb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.40"
  os_disk_name          = "lcippmdgmongodb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippmdgmongodb001_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmdgmongodb001"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmdgmongodb001"
