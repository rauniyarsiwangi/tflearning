...
module "lcippmdgmongodb002" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmdgmongodb002"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.41"
  os_disk_name          = "lcippmdgmongodb002"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippmdgmongodb002_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmdgmongodb002"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmdgmongodb002"
