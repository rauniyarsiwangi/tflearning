...
module "lcippmdgnginxdb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmdgnginxdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.44"
  os_disk_name          = "lcippmdgnginxdb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippmdgnginxdb001_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmdgnginxdb001"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmdgnginxdb001"
