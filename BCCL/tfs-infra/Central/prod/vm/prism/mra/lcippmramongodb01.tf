...
module "lcippmramongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmramongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.23"
  os_disk_name          = "lcippmramongodb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippmramongodb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmramongodb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmramongodb01"
