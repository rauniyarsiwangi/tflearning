...
module "lcippmramongodb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmramongodb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.24"
  os_disk_name          = "lcippmramongodb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippmramongodb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmramongodb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmramongodb02"
