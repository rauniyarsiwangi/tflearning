...
module "lcippscbmongodb003" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippscbmongodb003"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.48"
  os_disk_name          = "lcippscbmongodb003"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippscbmongodb003_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippscbmongodb003"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippscbmongodb003"
