...
module "lcippscbapp001" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-prism-scb-app-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcippscbapp001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.0.171"
  os_disk_name          = "lcippscbapp001"
