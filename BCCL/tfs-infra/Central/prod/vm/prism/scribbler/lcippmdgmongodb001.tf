...
module "lcippscbmongodb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippscbmongodb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.46"
  os_disk_name          = "lcippscbmongodb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcippscbmongodb001_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippscbmongodb001"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippscbmongodb001"
