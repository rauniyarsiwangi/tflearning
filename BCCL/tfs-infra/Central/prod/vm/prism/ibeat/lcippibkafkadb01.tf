...
module "lcippibkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippibkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.250"
  os_disk_name          = "lcippibkafkadb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippibkafkadb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippibkafkadb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippibkafkadb01"
