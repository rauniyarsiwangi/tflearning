...
module "lcippibelasticdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippibelasticdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.244"
  os_disk_name          = "lcippibelasticdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippibelasticdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippibelasticdb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippibelasticdb01"
