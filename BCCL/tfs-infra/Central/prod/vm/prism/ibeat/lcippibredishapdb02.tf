...
module "lcippibredishapdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippibredishapdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.34"
  os_disk_name          = "lcippibredishapdb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippibredishapdb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippibredishapdb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippibredishapdb02"
