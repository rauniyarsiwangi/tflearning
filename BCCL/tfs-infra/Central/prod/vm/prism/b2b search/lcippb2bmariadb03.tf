...
module "lcippb2bmariadb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippb2bmariadb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.52"
  os_disk_name          = "lcippb2bmariadb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippb2bmariadb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippb2bmariadb03"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippb2bmariadb03"
