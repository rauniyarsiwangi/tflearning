...
module "lcippb2bmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippb2bmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.50"
  os_disk_name          = "lcippb2bmariadb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippb2bmariadb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippb2bmariadb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippb2bmariadb01"
