...
module "lcippdamsolrdb07" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdamsolrdb07"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.130"
  os_disk_name          = "lcippdamsolrdb07"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdamsolrdb07_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdamsolrdb07"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdamsolrdb07"
