...
module "lcippdamsolrdb08" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdamsolrdb08"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.131"
  os_disk_name          = "lcippdamsolrdb08"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdamsolrdb08_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdamsolrdb08"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdamsolrdb08"
