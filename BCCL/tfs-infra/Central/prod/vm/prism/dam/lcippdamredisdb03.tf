...
module "lcippdamredisdb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdamredisdb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.135"
  os_disk_name          = "lcippdamredisdb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdamredisdb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdamredisdb03"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdamredisdb03"
