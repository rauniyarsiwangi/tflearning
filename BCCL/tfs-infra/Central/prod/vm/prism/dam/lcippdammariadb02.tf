...
module "lcippdammariadb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdammariadb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.137"
  os_disk_name          = "lcippdammariadb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdammariadb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdammariadb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdammariadb02"
