...
module "lcippdamsolrdb04" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdamsolrdb04"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.127"
  os_disk_name          = "lcippdamsolrdb04"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdamsolrdb04_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdamsolrdb04"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdamsolrdb04"
