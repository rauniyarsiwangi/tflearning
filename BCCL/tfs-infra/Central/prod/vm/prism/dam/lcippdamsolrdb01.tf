...
module "lcippdamsolrdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdamsolrdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.124"
  os_disk_name          = "lcippdamsolrdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdamsolrdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdamsolrdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdamsolrdb01"
