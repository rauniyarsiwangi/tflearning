...
module "lcipptmcmongodb001" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-prism-tmc-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcipptmcmongodb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.59"
  os_disk_name          = "lcipptmcmongodb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcipptmcmongodb001-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipptmcmongodb001"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipptmcmongodb001"
