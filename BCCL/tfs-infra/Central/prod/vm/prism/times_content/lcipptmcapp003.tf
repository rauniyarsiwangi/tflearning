...
module "lcipptmcapp003" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipptmcapp003"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.0.183"
  os_disk_name          = "lcipptmcapp003"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcipptmcapp003-datadisk-01"
