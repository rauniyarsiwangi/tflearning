...
module "lcipptmcredisdb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcipptmcredisdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.60"
  os_disk_name          = "lcipptmcredisdb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcipptmcredisdb001-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcipptmcredisdb001"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcipptmcredisdb001"
