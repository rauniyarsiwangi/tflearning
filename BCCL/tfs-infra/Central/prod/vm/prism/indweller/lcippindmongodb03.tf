...
module "lcippindmongodb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippindmongodb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.86"
  os_disk_name          = "lcippindmongodb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippindmongodb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippindmongodb03"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippindmongodb03"
