...
module "lcippdmelasticdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmelasticdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.45"
  os_disk_name          = "lcippdmelasticdb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmelasticdb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmelasticdb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmelasticdb02"
