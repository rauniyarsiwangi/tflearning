...
module "lcippdmmongodb05" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmongodb05"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.25"
  os_disk_name          = "lcippdmmongodb05"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmongodb05_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmongodb05"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmongodb05"
