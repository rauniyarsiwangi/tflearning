...
module "lcippdmmariadb04" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmariadb04"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.36"
  os_disk_name          = "lcippdmmariadb04"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmariadb04_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmariadb04"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmariadb04"
