...
module "lcippdmmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.33"
  os_disk_name          = "lcippdmmariadb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmariadb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmariadb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmariadb01"
