...
module "lcippdmmariadb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmariadb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.34"
  os_disk_name          = "lcippdmmariadb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmariadb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmariadb02"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmariadb02"
