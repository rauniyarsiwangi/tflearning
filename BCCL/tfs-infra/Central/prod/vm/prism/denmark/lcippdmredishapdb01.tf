...
module "lcippdmredishapdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmredishapdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.26"
  os_disk_name          = "lcippdmredishapdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmredishapdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmredishapdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmredishapdb01"
