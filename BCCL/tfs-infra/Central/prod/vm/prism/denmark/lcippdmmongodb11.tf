...
module "lcippdmmongodb11" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmongodb11"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.31"
  os_disk_name          = "lcippdmmongodb11"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmongodb11_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmongodb11"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmongodb11"
