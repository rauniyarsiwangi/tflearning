...
module "lcippdmmongodb06" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippdmmongodb06"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.26"
  os_disk_name          = "lcippdmmongodb06"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippdmmongodb06_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippdmmongodb06"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippdmmongodb06"
