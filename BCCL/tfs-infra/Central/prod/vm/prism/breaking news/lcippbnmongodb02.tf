...
module "lcippbnmongodb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippbnmongodb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.111"
  os_disk_name          = "lcippbnmongodb02"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippbnmongodb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippbnmongodb02"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippbnmongodb02"
