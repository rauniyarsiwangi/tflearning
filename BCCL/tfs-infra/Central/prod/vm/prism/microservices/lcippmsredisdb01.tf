...
module "lcippmsredisdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmsredisdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.121"
  os_disk_name          = "lcippmsredisdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippmsredisdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmsredisdb01"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmsredisdb01"
