...
module "lcippmsredisdb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmsredisdb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.123"
  os_disk_name          = "lcippmsredisdb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippmsredisdb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmsredisdb03"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmsredisdb03"
