...
module "lcippmselasticdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippmselasticdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.114"
  os_disk_name          = "lcippmselasticdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippmselasticdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippmselasticdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippmselasticdb01"
