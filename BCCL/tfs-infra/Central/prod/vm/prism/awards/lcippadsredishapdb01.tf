...
module "lcippadsredishapdb01" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-ads-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcippadsredishapdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.31"
  os_disk_name          = "lcippadsredishapdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippadsredishapdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippadsredishapdb01"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippadsredishapdb01"
