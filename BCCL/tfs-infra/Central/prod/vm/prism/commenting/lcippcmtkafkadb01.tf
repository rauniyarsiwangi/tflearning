...
module "lcippcmtkafkadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippcmtkafkadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.35"
  os_disk_name          = "lcippcmtkafkadb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippcmtkafkadb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippcmtkafkadb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippcmtkafkadb01"
