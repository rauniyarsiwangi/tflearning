...
module "lcippcmtelasticdb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippcmtelasticdb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.213"
  os_disk_name          = "lcippcmtelasticdb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippcmtelasticdb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippcmtelasticdb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippcmtelasticdb01"
