...
module "lcippcmtredisdb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippcmtredisdb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.221"
  os_disk_name          = "lcippcmtredisdb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippcmtredisdb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippcmtredisdb03"
      size                            = "Standard_D4as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippcmtredisdb03"
