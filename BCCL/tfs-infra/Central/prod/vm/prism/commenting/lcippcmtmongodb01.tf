...
module "lcippcmtmongodb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippcmtmongodb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.216"
  os_disk_name          = "lcippcmtmongodb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippcmtmongodb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippcmtmongodb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippcmtmongodb01"
