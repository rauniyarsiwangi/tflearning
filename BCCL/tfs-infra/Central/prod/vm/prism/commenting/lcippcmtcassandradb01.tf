...
module "lcippcmtcassandradb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippcmtcassandradb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.212"
  os_disk_name          = "lcippcmtcassandradb01"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippcmtcassandradb01_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippcmtcassandradb01"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippcmtcassandradb01"
