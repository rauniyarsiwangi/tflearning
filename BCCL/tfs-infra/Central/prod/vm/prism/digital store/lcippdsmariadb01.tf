...
#   data_disk_config = {
#     dd1 = {
#       name                 = "lcippdsmariadb01_datadisk-01"
...
#   vm_config = {
#     "vm1" = {
#       name                            = "lcippdsmariadb01"
#       size                            = "Standard_D4ls_v5"
#       admin_username                  = "azureadmin"
#       admin_password                  = null
#       computer_name                   = "lcippdsmariadb01"
