...
module "lcippaimlmongodb03" {
  ...
  public_ip_name        = ""
  nic_name              = "lcippaimlmongodb03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.189"
  os_disk_name          = "lcippaimlmongodb03"
  ...
  data_disk_config = {
    dd1 = {
      name                 = "lcippaimlmongodb03_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcippaimlmongodb03"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcippaimlmongodb03"
