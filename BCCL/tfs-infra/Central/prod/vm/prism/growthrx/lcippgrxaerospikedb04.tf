...
#   public_ip_name        = ""
#   nic_name              = "lcippgrxaerospikedb04"
#   pip_add_allocation    = "Static"
#   private_ip_address    = "10.11.9.21"
#   os_disk_name          = "lcippgrxaerospikedb04"
...
#   data_disk_config = {
#     dd1 = {
#    name = "lcippgrxaerospikedb04_datadisk-01"
...
#   vm_config = {
#     "vm1" = {
#       name           = "lcippgrxaerospikedb04"
#       size           = "Standard_D16as_v5"
#       admin_username = "azureadmin"
#       admin_password = null
#       computer_name = "lcippgrxaerospikedb04"
