...
module "lcisplogapp001" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-sw-log-001"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcisplogapp001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.0.172"
  os_disk_name          = "lcisplogapp001"
