...
module "lcispcmselasticdb010" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb010"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.56"
  os_disk_name          = "lcispcmselasticdb010"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb010-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb010"
      size                            = "Standard_D8as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb010"
