...
module "lcispcmselasticdb004" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb004"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.8"
  os_disk_name          = "lcispcmselasticdb004"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb004-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb004"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb004"
