...
module "lcispcmselasticdb003" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb003"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.7"
  os_disk_name          = "lcispcmselasticdb003"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb003-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb003"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb003"
