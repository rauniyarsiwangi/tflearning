...
module "lcispcmselasticdb009" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb009"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.9.55"
  os_disk_name          = "lcispcmselasticdb009"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb009-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb009"
      size                            = "Standard_D8as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb009"
