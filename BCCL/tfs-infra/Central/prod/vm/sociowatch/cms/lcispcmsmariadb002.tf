...
module "lcispcmsmariadb002" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmsmariadb002"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.12"
  os_disk_name          = "lcispcmsmariadb002"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmsmariadb002-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmsmariadb002"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmsmariadb002"
