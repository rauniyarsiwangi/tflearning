...
module "lcispcmskafkadb007" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmskafkadb007"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.19"
  os_disk_name          = "lcispcmskafkadb007"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmskafkadb007-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmskafkadb007"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmskafkadb007"
