...
module "lcispcmselasticdb006" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb006"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.10"
  os_disk_name          = "lcispcmselasticdb006"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb006-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb006"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb006"
