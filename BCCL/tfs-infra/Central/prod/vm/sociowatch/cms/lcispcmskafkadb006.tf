...
module "lcispcmskafkadb006" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmskafkadb006"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.18"
  os_disk_name          = "lcispcmskafkadb006"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmskafkadb006-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmskafkadb006"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmskafkadb006"
