...
module "lcispcmsmariadb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmsmariadb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.11"
  os_disk_name          = "lcispcmsmariadb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmsmariadb001-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmsmariadb001"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmsmariadb001"
