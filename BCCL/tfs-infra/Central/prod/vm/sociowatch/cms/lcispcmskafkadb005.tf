...
module "lcispcmskafkadb005" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmskafkadb005"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.17"
  os_disk_name          = "lcispcmskafkadb005"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmskafkadb005-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmskafkadb005"
      size                            = "Standard_D2as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmskafkadb005"
