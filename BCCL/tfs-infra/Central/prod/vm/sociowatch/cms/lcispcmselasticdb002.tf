...
module "lcispcmselasticdb002" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb002"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.6"
  os_disk_name          = "lcispcmselasticdb002"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb002-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb002"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb002"
