...
module "lcispcmselasticdb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcispcmselasticdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.8.5"
  os_disk_name          = "lcispcmselasticdb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lcispcmselasticdb001-datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispcmselasticdb001"
      size                            = "Standard_D8as_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispcmselasticdb001"
