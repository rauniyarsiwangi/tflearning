...
module "lcispartemisapp001" {
  source                = "../../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-central-prd-sw-artemis-001"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcispartemisapp001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.11.0.5"
  os_disk_name          = "lcispartemisapp001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcispartemisapp001"
      size                            = "Standard_D8ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcispartemisapp001"
