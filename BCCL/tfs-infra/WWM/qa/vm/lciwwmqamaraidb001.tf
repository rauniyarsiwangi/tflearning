...
module "lciwwmqamaraidb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmqamaraidb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.3.36"
  os_disk_name          = "lciwwmqamaraidb001"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmqamaraidb001_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmqamaraidb001"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmqamaraidb001"
