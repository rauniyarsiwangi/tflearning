...
module "lciwwmprdnfs01" {
  ...
  public_ip_name        = "lciwwmprdnfs01-pip"
  nic_name              = "lciwwmprdnfs01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.10"
  os_disk_name          = "lciwwmprdnfs01"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmprdnfs01_datadisk-01"
