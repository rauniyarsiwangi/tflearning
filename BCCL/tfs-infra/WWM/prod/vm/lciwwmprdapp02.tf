...
module "lciwwmprdapp02" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdapp02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.8"
  os_disk_name          = "lciwwmprdapp02"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmprdapp02_datadisk-01"
