...
module "lciwwmprdmemapp02" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdmemapp02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.7"
  os_disk_name          = "lciwwmprdmemapp02"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmprdmemapp02"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmprdmemapp02"
