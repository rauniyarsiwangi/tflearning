...
module "lciwwmprdmemapp01" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdmemapp01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.6"
  os_disk_name          = "lciwwmprdmemapp01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmprdmemapp01"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmprdmemapp01"
