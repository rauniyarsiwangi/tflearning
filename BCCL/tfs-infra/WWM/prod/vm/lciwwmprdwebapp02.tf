...
module "lciwwmprdwebapp02" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdwebapp02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.13"
  os_disk_name          = "lciwwmprdwebapp02"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmprdwebapp02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmprdwebapp02"
      size                            = "Standard_F2s_v2"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmprdwebapp02"
