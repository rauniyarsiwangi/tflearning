...
module "lciwwmprdghdb02" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdghdb02"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.78"
  os_disk_name          = "lciwwmprdghdb02"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmprdghdb02_datadisk-01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmprdghdb02"
      size                            = "Standard_F8s_v2"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmprdghdb02"
