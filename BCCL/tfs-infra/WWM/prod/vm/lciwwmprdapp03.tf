...
module "lciwwmprdapp03" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmprdapp03"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.0.9"
  os_disk_name          = "lciwwmprdapp03"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmprdapp03_datadisk-01"
