module "agw-ci-wwm-prd-shs-001" {
  source                        = "../../../../tfs-modules/azurerm_application_gateway"
  create_resource_group         = false
  resource_group_name           = "rsg-ci-wwm-prd-shs-01"
  location                      = "central india"
  subnet_name                   = "snt-ci-wwm-prd-appgw-01"
  virtual_network_name          = "vnet-ci-wwm-prd-net-01"
  vnet_rg_name                  = "rsg-ci-wwm-prd-net-01"
  pip_name                      = "pip-ci-wwm-prd-shs-01"
  appgw_name                    = "agw-ci-wwm-prd-shs-001"
  ...
  user_assigned_identity        = "mi-ci-wwm-prd-shs-01"
