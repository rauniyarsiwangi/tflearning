module "agw-ci-wwm-stg-shs-001" {
  source                        = "../../../../tfs-modules/azurerm_application_gateway"
  create_resource_group         = false
  resource_group_name           = "rsg-ci-wwm-stg-shs-01"
  location                      = "central india"
  subnet_name                   = "snt-ci-wwm-stg-appgw-01"
  virtual_network_name          = "vnet-ci-wwm-stg-net-01"
  vnet_rg_name                  = "rsg-ci-wwm-stg-net-01"
  pip_name                      = "pip-ci-wwm-stg-shs-001"
  appgw_name                    = "agw-ci-wwm-stg-shs-001"
  ...
  user_assigned_identity        = "mi-ci-wwm-stg-shs-01"
  enable_https_rule             = false
  # kv_name                       = "kv-ci-wwm-stg-shs-01"
  # kv_rg_name                    = "rsg-ci-wwm-stg-shs-01"
