...
module "lciwwmstgmariadb01" {
  ...
  public_ip_name        = ""
  nic_name              = "lciwwmstgmariadb01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.2.38"
  os_disk_name          = "lciwwmstgmariadb01"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lciwwmstgmariadb01"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lciwwmstgmariadb01"
