...
module "lciwwmstgapp01" {
  source                = "../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-wwm-stg-app-01"
  enable_ssh_key        = true
  ...
  kv_rg_name            = null
  kv_secret_name        = null
  subnet_name           = "snt-ci-wwm-stg-app-01"
  vnet_name             = "vnet-ci-wwm-stg-net-01"
  vnet_rg_name          = "rsg-ci-wwm-stg-net-01"
  create_public_ip      = false
  public_ip_name        = ""
  nic_name              = "lciwwmstgapp01"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.15.2.5"
  os_disk_name          = "lciwwmstgapp01"
  ...
  data_disk_config = {
    "dd1" = {
      name                 = "lciwwmstgapp01_datadisk-01"
