...
module "lcitdtmdredisdb001" {
  source                = "../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-tnn-dev-tmd-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcitdtmdredisdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.14.8.5"
  os_disk_name          = "lcitdtmdredisdb001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcitdtmdredisdb001"
      size                            = "Standard_D2ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcitdtmdredisdb001"
