module "agw-ci-tnn-prd-backend-tmd-001" {
  ...
  pip_name                      = "pip-ci-tnn-prd-appgw-01"
  appgw_name                    = "agw-ci-tnn-prd-backend-tmd-001"
  ...
  backend_address_pools = {
    "bpool" = {
      name         = "tmd-bpool1"
      ip_addresses = ["10.13.0.10", "10.13.0.11"]
    }
  }
