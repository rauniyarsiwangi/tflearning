...
module "lcitptmdapp003" {
  source                = "../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-tnn-prd-tmd-app-01"
  enable_ssh_key        = true
  ...
  kv_rg_name            = null
  kv_secret_name        = null
  subnet_name           = "snt-ci-tnn-prd-app-01"
  vnet_name             = "vnet-ci-tnn-prd-net-01"
  vnet_rg_name          = "rsg-ci-tnn-prd-net-01"
  create_public_ip      = false
  public_ip_name        = ""
  nic_name              = "lcitptmdapp003"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.13.0.10"
  os_disk_name          = "lcitptmdapp003"
