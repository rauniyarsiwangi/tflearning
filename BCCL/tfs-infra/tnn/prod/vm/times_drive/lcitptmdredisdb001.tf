...
module "lcitptmdredisdb001" {
  ...
  public_ip_name        = ""
  nic_name              = "lcitptmdredisdb001"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.13.8.6"
  os_disk_name          = "lcitptmdredisdb001"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcitptmdredisdb001"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcitptmdredisdb001"
