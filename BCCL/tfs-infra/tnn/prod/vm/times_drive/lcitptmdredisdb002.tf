...
module "lcitptmdredisdb002" {
  source                = "../../../../../tfs-modules/azurerm_virtual_machine"
  create_resource_group = false
  location              = "Central india"
  os_type               = "linux"
  resource_group_name   = "rsg-ci-tnn-prd-tmd-db-01"
  enable_ssh_key        = true
  ...
  public_ip_name        = ""
  nic_name              = "lcitptmdredisdb002"
  pip_add_allocation    = "Static"
  private_ip_address    = "10.13.8.7"
  os_disk_name          = "lcitptmdredisdb002"
  ...
  vm_config = {
    "vm1" = {
      name                            = "lcitptmdredisdb002"
      size                            = "Standard_D4ls_v5"
      admin_username                  = "azureadmin"
      admin_password                  = null
      computer_name                   = "lcitptmdredisdb002"
